...
export default function VisitasDomiciliarias() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Visita domiciliaria:", form);
    alert("Solicitud de visita domiciliaria registrada (mock).");
  };

  return (
    <DashboardLayout role="user">
      <h2 className="text-xl font-semibold mb-4">Visitas domiciliarias</h2>
      <p className="text-xs text-slate-400 mb-4">
        Solicitá un médico a domicilio para un empleado.
      </p>
